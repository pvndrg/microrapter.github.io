...
$select=mysqli_query($conn,"select * from message where receiver ='$temp' || sender='$temp'");


while($row1=mysqli_fetch_array($select)){
	$name=$row1['sender'];
	$name2=$row1['receiver'];
	$name1=$row1['personal_msg']
	//$name2=$row1['when'];
...
<tr>
<td width="300"><img src="  Buddy-Green.ico" width="14" height="14"><?php echo $name ;?> => <?php echo $name2 ;?> </td>
